...
namespace AlMohamyProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly IEmailSender _emailSender;
        public AccountController(IEmailSender emailSender, AlMohamyDbContext db,  UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
